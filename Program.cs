...
using (var scope = app.Services.CreateScope()) {
    if (!string.IsNullOrEmpty(connectionString)) {
        ...
        try { 
            // ************ איפוס הטבלה - תיקון לשגיאה 500 ************
            // השורה הזו מוחקת את הטבלה הישנה כדי ליצור חדשה עם העמודות הנכונות
            db.Database.ExecuteSqlRaw(@"DROP TABLE IF EXISTS ""Meals""");
            // *********************************************************
            ...
            // 2. יצירת טבלת ארוחות מחדש (הפעם עם MealType)
             db.Database.ExecuteSqlRaw(@"
...
public class Meal {
    ...
    public string MealType { get; set; } // השדה החדש!
}
